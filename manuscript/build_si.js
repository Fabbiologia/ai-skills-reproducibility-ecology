...
c.push(ctable(
  ...
  [
    ...
    ["LLM ecological knowledge benchmark (2026)", "J. Nat. Conserv.", "Ecology (IUCN spp.)", "General LLM outputs", "94.9% taxonomic vs 27.2% conservation-status accuracy", "Direct"],
    ["How Consistent Are LLM Agents? (2026, pre)", "arXiv", "Agents", "Repeated identical tool-calling runs", "Behavioural reproducibility imperfect; tool/order/arg drift", "Direct"],
    ...
    ["Nondeterminism in LLM inference (2025, pre)", "arXiv", "LLM", "Batch-invariant kernels; precision", "Bit-identical over 1,000 runs at ~61.5% throughput cost", "Direct"],
