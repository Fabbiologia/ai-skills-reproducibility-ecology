...
// ---------------- TITLE / AUTHORS ----------------
c.push(TITLE("Do AI skills improve the output reproducibility of ecological analyses? Controlled experiments"));
...
c.push(P("We first summarise what earlier work shows (Section 2). We then report two studies, one on a single analytical output (Sections 3 and 4) and one on a whole report (Section 5), and turn the results into practical guidance (Section 6). The experiments are the main contribution, and the literature review sets the context and is not a formal systematic review."));
...
c.push(H2("6.2  What a skill should contain to improve output reproducibility"));
...
c.push(H2("6.3  Implications for practice"));
...
c.push(H2("6.4  How this fits earlier work"));
...
c.push(H2("6.5  From single numbers to whole reports"));
